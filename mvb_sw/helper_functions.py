...
def stitch_video(video_path, frame_skip=1, H_templ_ratio=0.65):
    global H_templ_ratio_
...
def camera_record(url, crop_w, crop_h, record_flag: threading.Event, recording_done: threading.Event = None):
...
def fetch_scan_state(scan_state_url):
    try:
