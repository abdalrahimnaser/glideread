...
if __name__ == '__main__':
    ...
    # image_paths = [f"snap_{i}.png" for i in range(1, 13)]
    ...
    H_templ_ratio = 0.65 # H_templ_ratio: horizontal ratio of the input that we will keep to create a template
